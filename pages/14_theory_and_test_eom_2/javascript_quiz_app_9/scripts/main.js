...
let questions = [
    {
        text: 'Что не относится к причинам короткого замыкания:',
        right: 0,
        answers: ['недогрузка электрической сети', 'перегрузка электрической сети', 'повреждение коммутационных аппаратов','износ и старение электрооборудования'],
    },
];
