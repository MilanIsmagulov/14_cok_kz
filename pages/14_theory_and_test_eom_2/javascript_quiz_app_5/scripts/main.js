...
let questions = [
    {
        text: 'Выберете корректную формулу для расчета сопротивления элемента СЭС, выделенного на схеме красным цветом.',
        right: 3,
        answers: ['<img class="answer_img" src="./content/1_answer.jpg" alt="1">', '<img class="answer_img" src="./content/2_answer.jpg" alt="1">', '<img class="answer_img" src="./content/3_answer.jpg" alt="1">','<img class="answer_img" id="answer_img_4" src="./content/4_answer.jpg" alt="1">'],
    },
];
