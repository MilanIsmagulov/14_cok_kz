...
let questions = [
    {
        text: 'Укажите верную формулу для расчета x<sub>c</sub> трехобмоточного трансформатора:',
        right: 2,
        answers: ['<img class="answer_img" src="./content/1_answer.jpg" alt="1">', '<img class="answer_img" src="./content/2_answer.jpg" alt="1">', '<img class="answer_img" src="./content/3_answer.jpg" alt="1">',],
    },
];
